...
class TransfuserConfig:
    ...
    bkb_path: str = "/data/goodhsm2000/repos/DiffusionDrive/pytorch_model.bin"
    plan_anchor_path: str = "/data/goodhsm2000/repos/DiffusionDrive/kmeans_navsim_traj_20.npy"
    # plan_anchor_path: str = "/data/goodhsm2000/anchor_trajectory/trajectory_anchors_1_v2.npy"
    # plan_anchor_path: str = "/data/goodhsm2000/anchor_trajectory/trajectory_test.npy"
    # plan_anchor_path: str = "/data/goodhsm2000/anchor_trajectory/trajectory_anchors_256_xy.npy"
    latent: bool = False
