...
class AbstractFeatureBuilder:
    ...
    @abstractmethod
    def compute_features(self, agent_input: AgentInput, token: Optional[str] = None,) -> Dict[str, Tensor]:
        """
...
class AbstractTargetBuilder:
    ...
    @abstractmethod
    def compute_targets(self, scene: Scene, token: Optional[str] = None) -> Dict[str, Tensor]:
        """
